...
dataset = WifiCSIDataset('data/60Ghz_position_data.csv', True)
...
plt.savefig('output/model_CrossEntropyLoss_temp.png')
...
torch.save(best_epoch[1].state_dict(), 'output/model_CrossEntropyLoss_1.pt')